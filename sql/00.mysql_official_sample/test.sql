...
--   d.dept_name
-- FROM employees AS e
-- JOIN dept_emp AS m ON e.emp_no = m.emp_no AND e.gender = 'F'
-- JOIN departments as d ON m.dept_no = d.dept_no AND dept_name = 'Development'
-- LIMIT 10
-- ;
...
-- SELECT AVG(salary) INTO @global_mean FROM salaries;
--
-- SELECT
--   e.gender,
--   AVG(s.salary) - @global_mean as DIFF
